...
# 看板
    ...
    give @s oak_sign{display: {Name: '{"text": "右クリ復活", "color": "aqua"}'}, BlockEntityTag: {is_waxed: true, front_text: {color: "light_blue", has_glowing_text: true, messages: ['{"text": "右クリックで", "bold": true, "clickEvent": {"action": "run_command", "value": "/function repopo:system/revive"}}', '{"text": "復活"}', '""', '""']}}}
