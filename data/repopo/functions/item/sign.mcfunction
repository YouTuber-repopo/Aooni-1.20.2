...
# 看板
    ...
    give @s oak_sign{display: {Name: '{"text": "参加", "color": "green"}'}, BlockEntityTag: {is_waxed: true, front_text: {color: "green", has_glowing_text: true, messages: ['{"text": "参加", "bold": true, "clickEvent": "/team join Hiroshi @p"}', '""', '""', '""']}}}
    give @s oak_sign{display: {Name: '{"text": "不参加", "color": "green"}'}, BlockEntityTag: {is_waxed: true, front_text: {color: "purple", has_glowing_text: true, messages: ['{"text": "不参加", "bold": true, "clickEvent": "/team join Guest @p"}', '""', '""', '""']}}}
